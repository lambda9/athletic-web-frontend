    ...
    <div className="full-blog-grid">
        <div className="full-blog-post">
          <div className="full-blog-container">
            <h3 className="full-blog-date">7 October 2020</h3>
            <h1 className="full-blog-heading">
              Benefits and Advantages of going Vegetarian
            </h1>
            <h3 className="full-blog-author">Written by Unknown</h3>
            <img src={bgImg}/>
            <p className="full-blog-p">
              ...
              diseases.  Thinking about reducing or eliminating animal products from your
              diet? Whether you want to go vegan or simply add more plant-based
              foods to your diet, learn how making informed choices about what
              you eat can improve your health and reduce your risk of certain
              diseases.  Thinking about reducing or eliminating animal products from your
